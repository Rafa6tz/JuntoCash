...
const Nav = () => {
  return (
    <nav className='fixed inset-x-0 bottom-0 h-26 bg-white border-t border-gray-200 flex justify-between items-center p-4 opacity-95'>
        <Link to="/" className='flex flex-col items-center justify-center gap-2 hover:bg-blue-300 rounded-xl h-14 w-16'><LuChartColumn/><span className='text-xs'>Wallet</span></Link>
        <Link to="/graphs" className='flex flex-col items-center justify-center gap-2 hover:bg-blue-300 rounded-xl h-14 w-16'><LuChartPie/><span className='text-xs'>Graph</span></Link>
        <Link to="/transaction">
